...
public class OWLVizGraphPanel extends JPanel {
    ...
    public OWLVizGraphPanel(OWLVizView view,
        ...
        graphComponent.setNodeRenderer(new OWLClsNodeRenderer(graphComponent.getController(),
                                                              ...
                                                              new OWLClsNodeLabelRenderer(getOWLModelManager()), getOWLModelManager()));
...
//                            view.showInstance((Instance) selObj);
        ...
        graphComponent.addGraphSelectionModelListener(new GraphSelectionModelListener() {
            public void selectionChanged(GraphSelectionModelEvent event) {
                view.getSelectionModel().setSelectedClass((OWLClass) event.getSource().getSelectedObject());
            }
        });
        ...
        getGraphComponent().getGraphView().addMouseListener(new MouseAdapter() {
            ...
            private void showPopupMenu(MouseEvent e) {
                popupMenu.show(getGraphComponent().getGraphView(), e.getPoint().x, e.getPoint().y);
            }
        });
    }
    ...
    public void dispose() {
        view.getSelectionModel().removeSelectionListener(owlVizSelectionListener);
    }
